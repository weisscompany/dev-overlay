...
// Inject the HTML for the overlay
var overlayHTML = `
...
// Delay execution for iOS compatibility
setTimeout(function() {
  ...
  // Set current timestamp and user agent
  var n = new Date(),
    y = n.getFullYear(),
...
}, 200); // Delay by 200ms for better compatibility on iOS
